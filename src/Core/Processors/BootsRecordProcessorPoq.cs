...
{
    internal class BootsRecordProcessorPoq : ItemRecordProcessor<BootsRecord>
    {
        //ArmorRecord armorRecord;
        private new Logger _logger = new Logger(null, typeof(BootsRecordProcessorPoq));
        ...
        public BootsRecordProcessorPoq(ItemRecordsControllerPoq itemRecordsControllerPoq) : base(itemRecordsControllerPoq)
        {
        }
