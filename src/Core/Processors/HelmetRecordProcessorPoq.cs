...
{
    internal class HelmetRecordProcessorPoq : ItemRecordProcessor<HelmetRecord>
    {
        //ArmorRecord armorRecord;
        private new Logger _logger = new Logger(null, typeof(HelmetRecordProcessorPoq));
        ...
        public HelmetRecordProcessorPoq(ItemRecordsControllerPoq itemRecordsControllerPoq) : base(itemRecordsControllerPoq)
        {
        }
