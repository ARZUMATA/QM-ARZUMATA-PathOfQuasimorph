...
{
    internal class LeggingsRecordProcessorPoq : ItemRecordProcessor<LeggingsRecord>
    {
        //ArmorRecord armorRecord;
        private new Logger _logger = new Logger(null, typeof(LeggingsRecordProcessorPoq));
        ...
        public LeggingsRecordProcessorPoq(ItemRecordsControllerPoq itemRecordsControllerPoq) : base(itemRecordsControllerPoq)
        {
        }
